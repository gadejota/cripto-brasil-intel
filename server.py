...
FEEDS = [
    ...
    # ── CRIPTO GLOBAL — TIER 1 (líderes de cobertura) ────────────────────────
    {"url":"https://www.coindesk.com/arc/outboundfeeds/rss/",
     "name":"CoinDesk","src":"t-cd","cat":"cripto","br":False,"weight":1.9},
    {"url":"https://cointelegraph.com/rss",
     "name":"Cointelegraph","src":"t-ct","cat":"cripto","br":False,"weight":1.8},
    {"url":"https://www.theblock.co/rss.xml",
     "name":"The Block","src":"t-tb","cat":"cripto","br":False,"weight":1.8},
    {"url":"https://bitcoinmagazine.com/.rss/full/",
     "name":"Bitcoin Magazine","src":"t-bm","cat":"cripto","br":False,"weight":1.8},
    {"url":"https://decrypt.co/feed",
     "name":"Decrypt","src":"t-dc","cat":"cripto","br":False,"weight":1.6},
    {"url":"https://blockworks.co/feed",
     "name":"Blockworks","src":"t-bk","cat":"cripto","br":False,"weight":1.6},
    {"url":"https://thedefiant.io/feed",
     "name":"The Defiant","src":"t-def","cat":"cripto","br":False,"weight":1.5},
    {"url":"https://unchainedcrypto.com/feed/",
     "name":"Unchained Crypto","src":"t-uc","cat":"cripto","br":False,"weight":1.5},
    ...
    {"url":"https://dlnews.com/rss.xml",
     "name":"DL News","src":"t-dln","cat":"cripto","br":False,"weight":1.5},
...
# ─────────────────────────────────────────────────────────────────────────────
# KEYWORD LISTS para scoring
# ─────────────────────────────────────────────────────────────────────────────
CRYPTO_KW = ["bitcoin","btc","ethereum","eth","cripto","blockchain","defi","nft",
             "halving","etf","saylor","strategy","altcoin","stablecoin","wallet",
             "exchange","binance","coinbase","xrp","sol","solana","regulação"]
MACRO_KW  = ["fed","fomc","inflação","juros","cpi","pib","gdp","taxa","recessão",
             "powell","tesouro","treasury","yields","dólar","câmbio","selic"]
GEO_KW    = ["guerra","sanção","china","rússia","eua","europa","trump","iran",
             "conflito","geopolítica","embargo","taiwán","coréia"]


# ═════════════════════════════════════════════════════════════════════════════
# VIRAL SCORE — baseado em peso da fonte + relevância de keywords + bônus
# ═════════════════════════════════════════════════════════════════════════════
def score_article(a: dict) -> int:
    ...
    for kw in kw_map.get(a.get("cat", ""), []):
        if kw in text:
            score += 4
    if a.get("br"):
        score += 10
...
async def build_news(n_cripto=14, n_macro=8, n_geo=6) -> list:
    ...
    # Score após filtro (usa analyst_stars)
    for a in filtered:
